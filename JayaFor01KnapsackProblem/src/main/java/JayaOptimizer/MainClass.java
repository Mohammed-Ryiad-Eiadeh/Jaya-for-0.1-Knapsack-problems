...
public class MainClass {
    ...
    public static void main(String ...args) {
        ...
        var Convergence = new double[9][MaxGeneration]; //average convergence holder for eight jaya version among 1000 iteration

        IntStream.range(0, Convergence[0].length).forEach(i -> Convergence[0][i] = KnapsackProblem.GetOptimalProfits());

        println("Welcome to 0/1 Knapsack Problem via Jaya Algorithm");
        ...
        println("The performance of JAYA-VTF1 optimizer with mutation");
        ...
        println("The performance of JAYA-VTF2 optimizer");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF2,
                false,
        ...
        println("The performance of JAYA-VTF2 optimizer with mutation");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF2,
                true,
        ...
        println("The performance of JAYA-VTF3 optimizer");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF3,
                false,
        ...
        println("The performance of JAYA-VTF3 optimizer with mutation");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF3,
                true,
        ...
        println("The performance of JAYA-VTF4 optimizer");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF4,
                false,
        ...
        println("The performance of JAYA-VTF4 optimizer with mutation");
        JayaOpt = new JayaOptimizer(KnapsackProblem,
                CheckedPopulation,
                TFUN.VTF4,
                true,
