...
public class Evaluation {
     ...
     */
    public void SetNextGeneration(double[][] NewGeneration) {
     ...
     */
    public double[][] PrepareSolutions() {
     ...
     */
    public double[] PrepareSolution(double[] solution) {
     ...
     */
    public void DisplayPreparedSolutions() {
     ...
     */
    public double BestSolutionFitness() {
     ...
     */
    public double WorstSolutionFitness() {
     ...
     */
    public int GetRequiredNumberToReachTheBestSolution(double[] CurrentBest, int CurrentIter) {
        var Iter = 0;
